app.controller('ideaFilesCtrl', function($scope, $state, $stateParams, $previousState,
                                          apiService, growl, ideaFactory, formatterService,$popover ){
    ...
    $scope.batchDeleteClick = function()
    {
        angular.forEach($scope.files, function(file){
            ...
            if(file.checked=='1' && (formatterService.isMe(file.user_id) || $scope.currentIdea.role() >2 )  )
            {
