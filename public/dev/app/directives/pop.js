app.factory('Popup', function ($window, $document, $timeout, $compile, $parse) {
...
app.directive('popupShow', function (Popup, $parse, $timeout) {
        return {
            restrict: 'A',
            scope: true,
...
app.directive('popupAutoShow', function (Popup, $parse) {
        return {
            restrict: 'A',
            link: function (scope, element, attrs) {
